  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 commonWidth bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl border"
      >
        {/* Heading and logo */}
        <div className="w-full border border-neutral-800 shadow[0_0_30px_0_rgba(255,255,255,0.1)] bg-white/2 backdrop-blur-lg rounded-2xl h-[600px] flex flex-col gap-12 justify-center items-center mt-5 relative">
          {/* Heading */}
